...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:62z01XngwPKkF+pktZaA3IWWqFX5hQls+ArfzoTSXKI=",
        version = "v0.0.0-20200912093217-24a349004de1",
    )
    ...
    go_repository(
        ...
        sum = "h1:RGS7MuoO4EeRp68J5OWuANAi5oVYtLRl+3LoD5fkMns=",
        version = "v0.0.0-20200915050820-6d893a6b696e",
    )
    go_repository(
